...
export default function ProfileScreen() {
  ...
  const achievements = [
    ...
    { id: 5, name: "Club Legend", description: "Play 1000 matches", unlocked: false },
  ];

  const recentMatches = [
    { id: 1, opponent: "LA Galaxy", result: "W 3-1", goals: 1, assists: 1, date: "2024-03-20" },
    { id: 2, opponent: "New York Red Bulls", result: "W 2-0", goals: 0, assists: 2, date: "2024-03-15" },
    { id: 3, opponent: "Orlando City", result: "D 1-1", goals: 1, assists: 0, date: "2024-03-10" },
  ];
      ...
      <div className="container mx-auto px-4 py-8 max-w-6xl">
        ...
        <div className="mt-8">
          <div className="mb-6">
            ...
            <div className="flex flex-col md:flex-row md:items-center md:justify-between">
              <div>
                ...
                <p className="text-slate-300 mt-2">{player.position} • {player.club}</p>
              </div>
              <div className="mt-4 md:mt-0">
                <div className="text-right">
                  <div className="text-3xl font-bold text-yellow-400">Level {player.level}</div>
                  <div className="text-slate-400">Experience: {player.experience}/{player.nextLevelExp}</div>
                </div>
              </div>
            </div>
          </div>
          ...
          <div className="grid grid-cols-1 lg:grid-cols-3 gap-6 mb-8">
            ...
            <Card className="bg-slate-800/50 border-slate-700 p-6">
              <h3 className="text-lg font-semibold text-white mb-4">Career Stats</h3>
              <div className="grid grid-cols-2 gap-4">
                ...
                <div className="text-center">
                  <div className="text-2xl font-bold text-yellow-400">{stats.goals}</div>
                ...
                <div className="text-center">
                  <div className="text-2xl font-bold text-green-400">{stats.trophies}</div>
            ...
            <Card className="bg-slate-800/50 border-slate-700 p-6">
              ...
              <div className="space-y-2">
                ...
                <Progress value={(player.experience / player.nextLevelExp) * 100} className="h-3" />
                <div className="flex justify-between text-sm">
                  <span className="text-slate-400">Next Level</span>
                  <span className="text-white">{player.nextLevelExp - player.experience} XP needed</span>
                </div>
              </div>
            </Card>
          </div>
                  ...
                  >
                    <div className="flex items-center space-x-3">
                      ...
                      <div className="flex-1">
                        ...
                        {achievement.year && (
                          <p className="text-sm text-slate-400">{achievement.year}</p>
                        )}
          ...
          <Card className="bg-slate-800/50 border-slate-700 p-6 mt-8">
            ...
            <div className="space-y-3">
              {recentMatches.map((match) => (
                <div key={match.id} className="flex items-center justify-between p-4 rounded-lg bg-slate-700/30">
                  ...
                  <div className="text-right">
                    <div className="text-yellow-400 text-sm">{match.goals} Goals</div>
                    <div className="text-blue-400 text-sm">{match.assists} Assists</div>
                  </div>
                </div>
              ))}
            </div>
